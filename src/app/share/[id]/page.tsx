        ...
        <main className="min-h-screen bg-[radial-gradient(circle_at_top,_rgba(251,191,36,0.16),_transparent_32%),linear-gradient(180deg,_#f8fafc_0%,_#fffaf5_100%)] px-4 py-10 text-foreground sm:px-6">
            <div className="mx-auto flex max-w-2xl flex-col gap-6">
                <div className="space-y-3 text-center">
                    <p className="text-xs font-semibold uppercase tracking-[0.28em] text-stone-500">JustMemo Share</p>
                ...
                <article className="rounded-[28px] border border-stone-200/80 bg-white/92 p-6 shadow-[0_24px_60px_rgba(15,23,42,0.08)] backdrop-blur sm:p-8">
                    <MemoContent
