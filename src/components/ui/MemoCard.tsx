                    ...
                    <div className="flex flex-wrap gap-2" role="list" aria-label="标签列表">
                        {memo.tags?.map(tag => (
                            <span
                                key={tag}
                                role="listitem"
                                className="text-xs text-primary bg-primary/5 px-2 py-0.5 rounded-sm hover:bg-primary/10 cursor-pointer transition-colors focus-visible:ring-2 focus-visible:ring-primary/20 outline-none"
                                tabIndex={0}
                            >
                                #{tag}
                            </span>
