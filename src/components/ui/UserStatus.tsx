    ...
    if (user) {
        return (
            <div className={cn("space-y-2", isCollapsed ? "flex flex-col items-center" : "")}>
                <div
                    className={cn(
                        "flex items-center gap-2 p-2 bg-muted/40 rounded-sm border border-border/50 group/status transition-all",
                ...
                <Button
                    ...
                    disabled={loggingOut}
                    className={cn(
                        "flex items-center justify-start gap-2 h-auto py-2.5 px-2.5 rounded-sm hover:bg-muted text-muted-foreground hover:text-foreground font-normal",
