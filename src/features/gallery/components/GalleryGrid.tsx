                        ...
                        {groupedItems[month].map((item, idx) => (
                            ...
                            >
                                <div
                                    tabIndex={0}
                                    className={cn(
                                        "group relative overflow-hidden rounded-md border border-border/60 bg-card/85 p-2 shadow-[0_12px_30px_-22px_rgba(0,0,0,0.25)] transition-all duration-500 hover:border-primary/30 hover:bg-card focus:outline-none focus:ring-1 focus:ring-primary/30 hover:shadow-xl"
                                    )}
