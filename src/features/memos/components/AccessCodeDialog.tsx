                ...
                <div className="space-y-4">
                    <div className="space-y-2.5">
                        <div className="space-y-1">
                            <label htmlFor="access-code" className="text-sm font-medium leading-none text-foreground">
                                访问口令
                            </label>
                    ...
                    <div className="space-y-2.5">
                        <div className="space-y-1">
                            <label htmlFor="access-hint" className="text-sm font-medium leading-none text-foreground">
                                口令提示
