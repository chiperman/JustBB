...
>(({ className, align = "center", sideOffset = 4, ...props }, ref) => (
  <HoverCardPrimitive.Content
    ...
    className={cn(
      "z-50 w-72 rounded-inner border border-border/40 bg-popover backdrop-blur-xl p-5 text-popover-foreground shadow-notion-deep outline-none data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2",
      className
    )}
    {...props}
  />
    ...
    <HoverCard onOpenChange={handleOpenOption}>
      ...
      <HoverCardContent>
        <div className="space-y-3">
          <div className="text-[10px] text-primary/60 font-mono font-bold uppercase tracking-wider tabular-nums">
            #{memoNumber}
          </div>
