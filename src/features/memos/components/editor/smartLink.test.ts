...
describe("replaceSmartLinkToken", () => {
  it.each<LinkRenderMode>(["mention", "pill", "card", "image"])(
    "保留 %s 模式并替换原始 token",
    (mode) => {
        ...
        const nodes = [
          {
            pos: 3,
            node: {
              type: { name: "markupLink" },
              attrs: { id: "https://example.com", isPending: true },
            },
          },
          {
            pos: 8,
      ...
      descendants: (
        ...
        const nodes = [
          ...
          },
          {
            ...
            node: {
              type: { name: "markupLink" },
              attrs: { id: "https://other.example.com", isPending: true },
            },
          },
        ]
        ...
        const nodes = [
          {
            ...
            node: {
              type: { name: "markupLink" },
              attrs: { id: "https://example.com", isPending: false },
            },
          },
