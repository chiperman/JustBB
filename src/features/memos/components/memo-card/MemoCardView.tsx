...
export function MemoCardView({
  ...
  return (
    <article
      ...
      className={cn(
        "relative bg-card rounded-lg p-6 transition-all border border-border shadow-notion-card hover:shadow-md focus-within:ring-2 focus-within:ring-primary/10 group",
