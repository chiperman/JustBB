  ...
  return (
    <div className="relative group/expandable w-full">
      <motion.div
        ...
        animate={{
          height: isExpanded || !finalExpandable ? "auto" : collapsedHeight,
        }}
        ...
        <AnimatePresence>
          {!isExpanded && finalExpandable && (
            <motion.div
              ...
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
              className="absolute bottom-0 left-0 right-0 h-16 bg-gradient-to-t from-card to-transparent pointer-events-none z-10 expansion-mask"
            />
          )}
        </AnimatePresence>
      </motion.div>
