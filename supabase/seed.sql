...
ON CONFLICT (id) DO UPDATE SET owner_id = EXCLUDED.owner_id, content = EXCLUDED.content, tags = EXCLUDED.tags, is_pinned = EXCLUDED.is_pinned;

-- 2. [Multimedia & Locations] 富媒体与全球足迹
INSERT INTO memos (id, owner_id, content, tags, locations, created_at, word_count)
VALUES 
('22222222-2222-2222-2222-222222222221', '00000000-0000-0000-0000-000000000001', '这是一条带图的记录。 ![Nature](https://images.unsplash.com/photo-1470071459604-3b5ec3a7fe05?w=800) #风景', ARRAY['风景'], NULL, '2023-05-12 10:00:00+08', 20),
('22222222-2222-2222-2222-222222222222', '00000000-0000-0000-0000-000000000001', '在巴黎埃菲尔铁塔下。 ![Paris](https://images.unsplash.com/photo-1502602898657-3e91760cbb34?w=800) #巴黎 #足迹', ARRAY['巴黎', '足迹'], '[{"name": "Eiffel Tower", "lat": 48.8584, "lng": 2.2945}]'::jsonb, '2023-10-01 20:00:00+08', 35),
('22222222-2222-2222-2222-222222222223', '00000000-0000-0000-0000-000000000001', '成都漫游：下午在太古里。 #成都 #美食', ARRAY['成都', '美食'], '[{"name": "太古里", "lat": 30.6547, "lng": 104.0794}]'::jsonb, '2024-12-24 22:30:00+08', 25)
ON CONFLICT (id) DO NOTHING;
...
VALUES 
('33333333-3333-3333-3333-333333333331', '00000000-0000-0000-0000-000000000002', '我的银行卡备忘：[此处已隐藏]。', ARRAY['私密'], true, crypt('password123', gen_salt('bf')), '我最常用的基础密码', '2024-01-01 00:01:00+08', 15, NULL),
('33333333-3333-3333-3333-333333333332', '00000000-0000-0000-0000-000000000002', '这条记录已被删除，但在垃圾箱中可见。', ARRAY['垃圾箱'], false, NULL, NULL, '2025-12-31 23:59:59+08', 18, now() - interval '1 day')
ON CONFLICT (id) DO NOTHING;

-- 4. [Heatmap Burst] 大规模热力图生成 (使用确定性 UUID 确保幂等性)
-- 策略：生成 550 条记录，覆盖 2023-2026，频率随年份上升
INSERT INTO memos (id, owner_id, content, tags, created_at, word_count)
SELECT 
